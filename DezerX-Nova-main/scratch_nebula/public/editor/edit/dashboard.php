        ...
        <form action="/admin/extensions/nebula" method="POST" id="editor-form" autocomplete="off">
          <div class="editor-container">
            ...
            <div class="option">
              ...
              <p class="option-footer">Enable or disable the keybinds feature in X HUB HOSTINGER.</p>
            </div>
            ...
            <div class="option">
              ...
              <p class="option-footer">Choose to show or hide the X HUB HOSTINGER footer on the Pterodactyl dashboard.</p>
            </div>
