      ...
      <div class="editor fade">
        <form action="/admin/extensions/nebula" method="POST" id="editor-form" autocomplete="off">
          <div class="editor-container">
            ...
            <p class="editor-description">Modify the color scheme of X HUB HOSTINGER.</p>
...
<script>
  ...
  const preset_slate = [
    ...
    { item: element('#palette_sidebar_6'), value: "#ff0f0f" },
    { item: element('#palette_sidebar_7'), value: "#040814" },
    { item: element('#palette_sidebar_8'), value: "#ff0f0f" },
    { item: element('#palette_dashboard_1'), value: "#e9eaee" },
    { item: element('#palette_dashboard_2'), value: "#ff0f0f" },
